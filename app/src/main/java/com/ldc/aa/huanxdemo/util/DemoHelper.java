...
import com.ldc.aa.huanxdemo.EmojiconExampleGroupData;
import com.ldc.aa.huanxdemo.ui.MainActivity;
import com.ldc.aa.huanxdemo.ui.ChatActivity;
        ...
        easeUI.setEaseUserInfoProvider(new EaseUI.EaseUserInfoProvider() {
            ...
            public void setNickAndAvatar(Context context, EMMessage message, ImageView userAvatarView, TextView usernickView) {
                ...
                if (message.direct == EMMessage.Direct.SEND) {
                    ...
                    if (jsonAgent == null) {
                        userAvatarView.setImageResource(com.easemob.easeui.R.drawable.ease_default_avatar);
...
//                            usernickView.setText(message.getFrom());
                        ...
                        if (!TextUtils.isEmpty(strUrl)) {
                            ...
                            //正常的string路径
                            Glide.with(context).load(strUrl).diskCacheStrategy(DiskCacheStrategy.ALL).placeholder(com.easemob.easeui.R.drawable.ease_default_avatar).into(userAvatarView);
                        } else {
                            Glide.with(context).load(com.easemob.easeui.R.drawable.ease_default_avatar).into(userAvatarView);
                        }
                    }
                }
            }
